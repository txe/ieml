...
//-------------------------------------------------------------------------
void ReportDiplom2015::GetDirectData(DirectData& dirData, const r::PrivateData& privData)
{
...
//-------------------------------------------------------------------------
void ReportDiplom2015::GetDiscipInfo(int studentId, std::vector<Discip>& cursDiscip, std::vector<Discip>& commonDiscip, std::vector<Discip>& specDiscip, string_t lang, string_t vkrTitle, bool useZe, bool anotherEnd)
{
  struct fun
  {
...
int ReportDiplom2015::PrepareDiscipTitle(string_t& title, int symbolMax)
{
...
//-------------------------------------------------------------------------
bool ReportDiplom2015::AddDiscip(std::vector<Discip>& disList, const Discip& discip)
{
