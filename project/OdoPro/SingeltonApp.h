...
namespace vok_key
{
  enum VOK_KEY {VK_GRP, VK_EDUCATIONS, VK_EDUDOC, VK_EDUFORM, VK_SPECS, VK_SPEZIALIZ, VK_QUALIFIC, VK_DIRECT, VK_DISCIPCLASSIFIC, VK_SHIFRSPEC, VK_DOG_YEAR, VK_DOG_SHIFR, VK_DOG_FAST};
}
