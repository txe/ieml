...
void __fastcall TFormStatistic::FormShow(TObject *Sender)
{
  ...
  FormSelected->UpdateComboBox(ComboBoxeducation,EDUCATIONS);
  ComboBoxeducation->ItemIndex=0;
  FormSelected->UpdateComboBox(ComboBoxlanguage,LANGUAGES);
  ComboBoxlanguage->ItemIndex=0;
  FormSelected->UpdateComboBox(ComboBoxdogyear,DOGYEARS);
  ComboBoxdogyear->ItemIndex=0;
  FormSelected->UpdateComboBox(ComboBoxgroup,GROUPS);
  ComboBoxgroup->ItemIndex=0;
  FormSelected->UpdateComboBox(ComboBoxspec,SPECS);
  ComboBoxspec->ItemIndex=0;
  FormSelected->UpdateComboBox(ComboBoxeduform,EDUFORMS);
  ComboBoxeduform->ItemIndex=0;
  FormSelected->UpdateComboBox(ComboBoxdogfast,DOGFASTS);
...
void __fastcall TFormStatistic::BtnStatisticClick(TObject *Sender)
{
  ...
  {
   Strtmp=FormSelected->GetNumForKeyTitle(EDUCATIONS,ComboBoxeducation->Text);
  ...
  {
   Strtmp=FormSelected->GetNumForKeyTitle(LANGUAGES,ComboBoxlanguage->Text);
  ...
  {
   Strtmp=FormSelected->GetNumForKeyTitle(DOGYEARS,ComboBoxdogyear->Text);
  ...
  {
   Strtmp=FormSelected->GetNumForKeyTitle(GROUPS,ComboBoxgroup->Text);
  ...
  {
   Strtmp=FormSelected->GetNumForKeyTitle(SPECS,ComboBoxspec->Text);
  ...
  {
   Strtmp=FormSelected->GetNumForKeyTitle(EDUFORMS,ComboBoxeduform->Text);
  ...
  {
   Strtmp=FormSelected->GetNumForKeyTitle(DOGFASTS,ComboBoxdogfast->Text);
