...
// }
  ...
  // т.к. в этом дипломе место мало то убрал перенос (заочная форма)
  AnsiString OutS = " году в федеральном государственном бюджетном образовательном учреждении высшего образования \"\"Нижегородский государственный архитектурно-строительный университет\"\" (заочная форма)";
