...
#ifndef UnitReportActPriemSdachaDelH
#define UnitReportActPriemSdachaDelH
...
//---------------------------------------------------------------------------
class TFormReportActPriemSdachaDel : public TForm
{
...
public:		// User declarations
        __fastcall TFormReportActPriemSdachaDel(TComponent* Owner);
        void __fastcall SetIDGroup(int _IDGroup);
        int __fastcall GetIDGroup(void);
};
//---------------------------------------------------------------------------
extern PACKAGE TFormReportActPriemSdachaDel *FormReportActPriemSdachaDel;
//---------------------------------------------------------------------------
#endif
