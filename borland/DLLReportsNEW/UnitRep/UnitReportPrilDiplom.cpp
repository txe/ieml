...
*/
  ...
  AnsiString OutS = " году в федеральном государственном бюджетном образовательном учреждении высшего образования \"\"Нижегородский государственный архитектурно-строительный университет\"\"\n(заочная форма)";
 ...
 */
  ...
  macros.InsertLine("ActiveDocument.Tables.Item(1).Cell(5,2).Range.Select");
  macros.InsertLine("ActiveDocument.Tables.Item(1).Cell(5,2).VerticalAlignment=wdCellAlignVerticalCenter");
  macros.InsertLine("ActiveDocument.Tables.Item(1).Cell(5,2).Range.Text=\"высшего образования\"");
