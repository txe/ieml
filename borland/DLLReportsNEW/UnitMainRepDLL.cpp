...
DWORD WINAPI ThreadProc(LPVOID lParam)
{
  // ::CoInitialize(NULL);
   ...
   forreport* param = (forreport*) lParam;

   int index = param->index;
   int _IDGroup = param->_IDGroup;
   int _IDStudent = param->_IDStudent;
...
{
   //forreport* lParam = new forreport;

   //lParam->index = index;
   //lParam->_IDGroup = _IDGroup;
   //lParam->_IDStudent = _IDStudent;
       // создаём поток, не забываем принять ID потока
   //DWORD id;
